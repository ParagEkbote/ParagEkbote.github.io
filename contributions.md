...
**Combined repository stars:** 471,689 ⭐
...
- `huggingface/transformers` → 6 PRs, ⭐ 161,074
...
- `huggingface/transformers` → ⭐ 161,074, forks 33,367, open issues 2,377
- `pytorch/pytorch` → ⭐ 100,275, forks 27,893, open issues 18,353
