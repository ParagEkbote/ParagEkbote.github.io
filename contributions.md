...
- `huggingface/transformers` → 6 PRs, ⭐ 161,863
- `pytorch/pytorch` → 2 PRs, ⭐ 101,029
- `hiyouga/LlamaFactory` → 1 PR, ⭐ 72,451
- `huggingface/diffusers` → 19 PRs, ⭐ 33,916
- `huggingface/trl` → 2 PRs, ⭐ 18,701
- `dagster-io/dagster` → 1 PR, ⭐ 15,740
- `optuna/optuna` → 7 PRs, ⭐ 14,398
- `Lightning-AI/litgpt` → 1 PR, ⭐ 13,434
- `linkedin/Liger-Kernel` → 11 PRs, ⭐ 6,453
...
112. [Add Missing Doc Links for Trackio](https://github.com/zenml-io/zenml/pull/4989) — `zenml-io/zenml`
113. [Add Trackio Integration for ZenML](https://github.com/zenml-io/zenml/pull/4841) — `zenml-io/zenml`
...
- `huggingface/transformers` → ⭐ 161,863, forks 33,585, open issues 2,441
- `pytorch/pytorch` → ⭐ 101,029, forks 28,112, open issues 18,335
- `hiyouga/LlamaFactory` → ⭐ 72,451, forks 8,862, open issues 1,056
- `huggingface/diffusers` → ⭐ 33,916, forks 7,084, open issues 1,234
- `huggingface/trl` → ⭐ 18,701, forks 2,803, open issues 491
- `dagster-io/dagster` → ⭐ 15,740, forks 2,168, open issues 2,596
- `optuna/optuna` → ⭐ 14,398, forks 1,346, open issues 32
- `Lightning-AI/litgpt` → ⭐ 13,434, forks 1,461, open issues 265
- `linkedin/Liger-Kernel` → ⭐ 6,453, forks 543, open issues 143
- `skorch-dev/skorch` → ⭐ 6,167, forks 409, open issues 64
- `zenml-io/zenml` → ⭐ 5,457, forks 627, open issues 133
- `mlabonne/llm-datasets` → ⭐ 4,662, forks 386, open issues 9
- `huggingface/notebooks` → ⭐ 4,581, forks 1,821, open issues 225
- `huggingface/blog` → ⭐ 3,446, forks 1,023, open issues 247
- `argilla-io/distilabel` → ⭐ 3,295, forks 246, open issues 99
- `alibaba/ROLL` → ⭐ 3,264, forks 291, open issues 116
- `huggingface/cookbook` → ⭐ 2,685, forks 409, open issues 60
- `huggingface/lighteval` → ⭐ 2,460, forks 495, open issues 333
- `gradio-app/trackio` → ⭐ 1,543, forks 119, open issues 8
- `PrunaAI/pruna` → ⭐ 1,231, forks 92, open issues 41
...
- `optuna/optuna-integration` → ⭐ 72, forks 43, open issues 7
- `optuna/optunahub-registry` → ⭐ 55, forks 62, open issues 13
