...
**Combined repository stars:** 474,696 ⭐
...
- `huggingface/transformers` → 6 PRs, ⭐ 161,768
- `pytorch/pytorch` → 2 PRs, ⭐ 100,915
- `hiyouga/LlamaFactory` → 1 PR, ⭐ 72,318
- `huggingface/diffusers` → 19 PRs, ⭐ 33,893
- `huggingface/trl` → 2 PRs, ⭐ 18,682
- `dagster-io/dagster` → 1 PR, ⭐ 15,728
- `optuna/optuna` → 7 PRs, ⭐ 14,376
- `Lightning-AI/litgpt` → 1 PR, ⭐ 13,430
- `linkedin/Liger-Kernel` → 11 PRs, ⭐ 6,445
- `skorch-dev/skorch` → 6 PRs, ⭐ 6,167
...
- `huggingface/transformers` → ⭐ 161,768, forks 33,565, open issues 2,450
- `pytorch/pytorch` → ⭐ 100,915, forks 28,072, open issues 18,318
- `hiyouga/LlamaFactory` → ⭐ 72,318, forks 8,851, open issues 1,054
- `huggingface/diffusers` → ⭐ 33,893, forks 7,073, open issues 1,206
- `huggingface/trl` → ⭐ 18,682, forks 2,797, open issues 512
- `dagster-io/dagster` → ⭐ 15,728, forks 2,166, open issues 2,644
- `optuna/optuna` → ⭐ 14,376, forks 1,343, open issues 33
- `Lightning-AI/litgpt` → ⭐ 13,430, forks 1,459, open issues 267
- `linkedin/Liger-Kernel` → ⭐ 6,445, forks 543, open issues 143
- `skorch-dev/skorch` → ⭐ 6,167, forks 410, open issues 64
- `mlabonne/llm-datasets` → ⭐ 4,659, forks 386, open issues 9
- `huggingface/notebooks` → ⭐ 4,585, forks 1,821, open issues 225
- `huggingface/blog` → ⭐ 3,445, forks 1,021, open issues 250
- `argilla-io/distilabel` → ⭐ 3,285, forks 245, open issues 99
- `alibaba/ROLL` → ⭐ 3,246, forks 290, open issues 115
- `huggingface/cookbook` → ⭐ 2,682, forks 409, open issues 60
- `huggingface/lighteval` → ⭐ 2,456, forks 491, open issues 332
- `gradio-app/trackio` → ⭐ 1,539, forks 119, open issues 8
- `PrunaAI/pruna` → ⭐ 1,226, forks 91, open issues 43
- `NannyML/The-Little-Book-of-ML-Metrics` → ⭐ 999, forks 82, open issues 97
- `huggingface/dataset-viewer` → ⭐ 871, forks 118, open issues 166
- `optuna/optuna-examples` → ⭐ 851, forks 196, open issues 3
- `Meesho/BharatMLStack` → ⭐ 693, forks 78, open issues 33
- `cfahlgren1/observers` → ⭐ 254, forks 27, open issues 18
- `optuna/optuna-integration` → ⭐ 71, forks 43, open issues 7
- `optuna/optunahub-registry` → ⭐ 55, forks 62, open issues 14
- `dagster-io/community-integrations` → ⭐ 54, forks 45, open issues 33
