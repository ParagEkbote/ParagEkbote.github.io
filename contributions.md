...
- `huggingface/transformers` → 6 PRs, ⭐ 161,830
- `pytorch/pytorch` → 2 PRs, ⭐ 100,972
- `hiyouga/LlamaFactory` → 1 PR, ⭐ 72,405
- `huggingface/diffusers` → 19 PRs, ⭐ 33,907
- `huggingface/trl` → 2 PRs, ⭐ 18,694
- `dagster-io/dagster` → 1 PR, ⭐ 15,736
- `optuna/optuna` → 7 PRs, ⭐ 14,388
- `Lightning-AI/litgpt` → 1 PR, ⭐ 13,432
- `linkedin/Liger-Kernel` → 11 PRs, ⭐ 6,452
...
112. [Add Trackio Integration for ZenML](https://github.com/zenml-io/zenml/pull/4841) — `zenml-io/zenml`
...
- `zenml-io/zenml`: 1 PRs

### 📦 Repository Activity (sorted by stars)
- `huggingface/transformers` → ⭐ 161,830, forks 33,575, open issues 2,445
- `pytorch/pytorch` → ⭐ 100,972, forks 28,097, open issues 18,322
- `hiyouga/LlamaFactory` → ⭐ 72,405, forks 8,858, open issues 1,057
- `huggingface/diffusers` → ⭐ 33,907, forks 7,080, open issues 1,226
- `huggingface/trl` → ⭐ 18,694, forks 2,800, open issues 500
- `dagster-io/dagster` → ⭐ 15,736, forks 2,168, open issues 2,616
- `optuna/optuna` → ⭐ 14,388, forks 1,345, open issues 33
- `Lightning-AI/litgpt` → ⭐ 13,432, forks 1,459, open issues 268
- `linkedin/Liger-Kernel` → ⭐ 6,452, forks 543, open issues 144
- `skorch-dev/skorch` → ⭐ 6,167, forks 409, open issues 64
- `zenml-io/zenml` → ⭐ 5,454, forks 627, open issues 139
- `mlabonne/llm-datasets` → ⭐ 4,662, forks 386, open issues 9
- `huggingface/notebooks` → ⭐ 4,584, forks 1,821, open issues 225
- `huggingface/blog` → ⭐ 3,445, forks 1,022, open issues 249
- `argilla-io/distilabel` → ⭐ 3,292, forks 246, open issues 99
- `alibaba/ROLL` → ⭐ 3,260, forks 291, open issues 116
- `huggingface/cookbook` → ⭐ 2,684, forks 409, open issues 60
- `huggingface/lighteval` → ⭐ 2,458, forks 494, open issues 334
- `gradio-app/trackio` → ⭐ 1,542, forks 119, open issues 8
- `PrunaAI/pruna` → ⭐ 1,228, forks 92, open issues 40
...
- `Meesho/BharatMLStack` → ⭐ 693, forks 77, open issues 33
