...
**Combined repository stars:** 481,260 ⭐
...
- `huggingface/transformers` → 6 PRs, ⭐ 161,989
- `pytorch/pytorch` → 2 PRs, ⭐ 101,172
- `hiyouga/LlamaFactory` → 1 PR, ⭐ 72,634
- `huggingface/diffusers` → 19 PRs, ⭐ 33,947
- `huggingface/trl` → 2 PRs, ⭐ 18,727
- `dagster-io/dagster` → 1 PR, ⭐ 15,761
- `optuna/optuna` → 7 PRs, ⭐ 14,419
- `Lightning-AI/litgpt` → 1 PR, ⭐ 13,445
- `linkedin/Liger-Kernel` → 11 PRs, ⭐ 6,465
...
- `huggingface/transformers` → ⭐ 161,989, forks 33,625, open issues 2,462
- `pytorch/pytorch` → ⭐ 101,172, forks 28,146, open issues 18,262
- `hiyouga/LlamaFactory` → ⭐ 72,634, forks 8,881, open issues 1,056
- `huggingface/diffusers` → ⭐ 33,947, forks 7,100, open issues 1,235
- `huggingface/trl` → ⭐ 18,727, forks 2,809, open issues 477
- `dagster-io/dagster` → ⭐ 15,761, forks 2,171, open issues 2,581
- `optuna/optuna` → ⭐ 14,419, forks 1,347, open issues 32
- `Lightning-AI/litgpt` → ⭐ 13,445, forks 1,465, open issues 265
- `linkedin/Liger-Kernel` → ⭐ 6,465, forks 546, open issues 149
- `skorch-dev/skorch` → ⭐ 6,167, forks 409, open issues 64
- `zenml-io/zenml` → ⭐ 5,463, forks 628, open issues 131
- `mlabonne/llm-datasets` → ⭐ 4,669, forks 388, open issues 10
- `huggingface/notebooks` → ⭐ 4,583, forks 1,822, open issues 225
- `huggingface/blog` → ⭐ 3,447, forks 1,023, open issues 245
- `argilla-io/distilabel` → ⭐ 3,303, forks 246, open issues 99
- `alibaba/ROLL` → ⭐ 3,271, forks 292, open issues 115
- `huggingface/cookbook` → ⭐ 2,689, forks 409, open issues 60
- `huggingface/lighteval` → ⭐ 2,463, forks 496, open issues 335
- `gradio-app/trackio` → ⭐ 1,550, forks 120, open issues 9
- `PrunaAI/pruna` → ⭐ 1,235, forks 93, open issues 36
- `NannyML/The-Little-Book-of-ML-Metrics` → ⭐ 999, forks 82, open issues 97
- `huggingface/dataset-viewer` → ⭐ 876, forks 119, open issues 166
- `optuna/optuna-examples` → ⭐ 852, forks 196, open issues 3
- `Meesho/BharatMLStack` → ⭐ 693, forks 78, open issues 33
- `cfahlgren1/observers` → ⭐ 255, forks 27, open issues 18
- `optuna/optuna-integration` → ⭐ 73, forks 43, open issues 7
- `optuna/optunahub-registry` → ⭐ 56, forks 62, open issues 14
