...
**Combined repository stars:** 473,849 ⭐
...
- `huggingface/transformers` → 6 PRs, ⭐ 161,575
- `pytorch/pytorch` → 2 PRs, ⭐ 100,735
- `hiyouga/LlamaFactory` → 1 PR, ⭐ 72,149
- `huggingface/diffusers` → 19 PRs, ⭐ 33,847
- `huggingface/trl` → 2 PRs, ⭐ 18,633
- `dagster-io/dagster` → 1 PR, ⭐ 15,682
- `optuna/optuna` → 7 PRs, ⭐ 14,351
- `Lightning-AI/litgpt` → 1 PR, ⭐ 13,423
- `linkedin/Liger-Kernel` → 11 PRs, ⭐ 6,430
- `skorch-dev/skorch` → 6 PRs, ⭐ 6,166
...
- `huggingface/transformers` → ⭐ 161,575, forks 33,499, open issues 2,444
- `pytorch/pytorch` → ⭐ 100,735, forks 28,009, open issues 18,396
- `hiyouga/LlamaFactory` → ⭐ 72,149, forks 8,824, open issues 1,039
- `huggingface/diffusers` → ⭐ 33,847, forks 7,055, open issues 1,182
- `huggingface/trl` → ⭐ 18,633, forks 2,791, open issues 584
- `dagster-io/dagster` → ⭐ 15,682, forks 2,160, open issues 2,660
- `optuna/optuna` → ⭐ 14,351, forks 1,340, open issues 38
- `Lightning-AI/litgpt` → ⭐ 13,423, forks 1,458, open issues 264
- `linkedin/Liger-Kernel` → ⭐ 6,430, forks 540, open issues 146
- `skorch-dev/skorch` → ⭐ 6,166, forks 410, open issues 64
- `mlabonne/llm-datasets` → ⭐ 4,646, forks 386, open issues 12
- `huggingface/notebooks` → ⭐ 4,573, forks 1,823, open issues 225
- `huggingface/blog` → ⭐ 3,441, forks 1,019, open issues 248
- `argilla-io/distilabel` → ⭐ 3,251, forks 243, open issues 97
- `alibaba/ROLL` → ⭐ 3,228, forks 289, open issues 114
- `huggingface/cookbook` → ⭐ 2,680, forks 410, open issues 60
- `huggingface/lighteval` → ⭐ 2,447, forks 486, open issues 322
- `gradio-app/trackio` → ⭐ 1,529, forks 119, open issues 6
- `PrunaAI/pruna` → ⭐ 1,213, forks 91, open issues 48
- `NannyML/The-Little-Book-of-ML-Metrics` → ⭐ 999, forks 82, open issues 97
- `huggingface/dataset-viewer` → ⭐ 871, forks 116, open issues 167
- `optuna/optuna-examples` → ⭐ 851, forks 198, open issues 4
- `Meesho/BharatMLStack` → ⭐ 693, forks 79, open issues 32
- `cfahlgren1/observers` → ⭐ 253, forks 27, open issues 18
- `optuna/optuna-integration` → ⭐ 71, forks 43, open issues 8
- `optuna/optunahub-registry` → ⭐ 55, forks 62, open issues 17
- `dagster-io/community-integrations` → ⭐ 54, forks 45, open issues 32
