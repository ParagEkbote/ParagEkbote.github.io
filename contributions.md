...
**Combined repository stars:** 481,480 ⭐
...
- `huggingface/transformers` → 6 PRs, ⭐ 162,014
- `pytorch/pytorch` → 2 PRs, ⭐ 101,212
- `hiyouga/LlamaFactory` → 1 PR, ⭐ 72,750
- `huggingface/diffusers` → 19 PRs, ⭐ 33,953
- `huggingface/trl` → 2 PRs, ⭐ 18,732
- `dagster-io/dagster` → 1 PR, ⭐ 15,765
- `optuna/optuna` → 7 PRs, ⭐ 14,425
- `Lightning-AI/litgpt` → 1 PR, ⭐ 13,450
- `linkedin/Liger-Kernel` → 11 PRs, ⭐ 6,471
...
- `huggingface/transformers` → ⭐ 162,014, forks 33,630, open issues 2,443
- `pytorch/pytorch` → ⭐ 101,212, forks 28,162, open issues 18,268
- `hiyouga/LlamaFactory` → ⭐ 72,750, forks 8,884, open issues 1,056
- `huggingface/diffusers` → ⭐ 33,953, forks 7,102, open issues 1,237
- `huggingface/trl` → ⭐ 18,732, forks 2,811, open issues 470
- `dagster-io/dagster` → ⭐ 15,765, forks 2,172, open issues 2,581
- `optuna/optuna` → ⭐ 14,425, forks 1,348, open issues 32
- `Lightning-AI/litgpt` → ⭐ 13,450, forks 1,464, open issues 265
- `linkedin/Liger-Kernel` → ⭐ 6,471, forks 547, open issues 153
- `skorch-dev/skorch` → ⭐ 6,167, forks 409, open issues 64
- `zenml-io/zenml` → ⭐ 5,463, forks 628, open issues 132
- `mlabonne/llm-datasets` → ⭐ 4,670, forks 388, open issues 10
- `huggingface/notebooks` → ⭐ 4,583, forks 1,825, open issues 225
- `huggingface/blog` → ⭐ 3,446, forks 1,023, open issues 245
- `argilla-io/distilabel` → ⭐ 3,304, forks 246, open issues 99
- `alibaba/ROLL` → ⭐ 3,273, forks 292, open issues 115
- `huggingface/cookbook` → ⭐ 2,690, forks 410, open issues 60
- `huggingface/lighteval` → ⭐ 2,463, forks 496, open issues 333
- `gradio-app/trackio` → ⭐ 1,551, forks 121, open issues 9
- `PrunaAI/pruna` → ⭐ 1,235, forks 94, open issues 36
...
- `optuna/optuna-examples` → ⭐ 853, forks 196, open issues 3
- `Meesho/BharatMLStack` → ⭐ 693, forks 78, open issues 33
- `cfahlgren1/observers` → ⭐ 255, forks 27, open issues 18
- `optuna/optuna-integration` → ⭐ 74, forks 43, open issues 7
- `optuna/optunahub-registry` → ⭐ 56, forks 62, open issues 15
- `dagster-io/community-integrations` → ⭐ 54, forks 46, open issues 31
